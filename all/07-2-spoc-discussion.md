...
31.  面包店(2001) 面包师有很多面包，由n个销售人员推销。每人顾客进店后先取一个号，并且等待叫号。当一个销售人员空闲下来时，就叫下一个号。试设计一个使销售人员和顾客同步的算法。

代码分别在[信号量](https://github.com/december/os_data/blob/master/breadshop_sem.py)和[条件变量](https://github.com/december/os_data/blob/master/breadshop_cond.py)查看。
3
